...
const IG = 'https://www.instagram.com/quiropractico_jm/'

export default function Footer() {
  return (
    <footer style={{ background: '#1B3A6B', padding: '56px 24px' }}>
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', justifyContent: 'center' }}>
          <motion.a href={`https://wa.me/${WA}`} target="_blank" rel="noopener noreferrer"
            ...
            style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '10px 20px', borderRadius: 999, background: '#25D366', color: '#fff', fontSize: 14, fontWeight: 600, textDecoration: 'none' }}>
          ...
          <motion.a href={IG} target="_blank" rel="noopener noreferrer"
            whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }}
            style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '10px 20px', borderRadius: 999, background: 'linear-gradient(45deg, #f09433, #e6683c, #dc2743, #cc2366, #bc1888)', color: '#fff', fontSize: 14, fontWeight: 600, textDecoration: 'none' }}>
            <svg width="17" height="17" viewBox="0 0 24 24" fill="white">
